...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadOrders() {
        const orders = OrderManager.getOrders(OrderManager.ORDER_STATUS.PENDING_SHIPMENT);
            ...
            return `
                <div class="order-card" data-order-id="${order.id}">
                    <div class="order-header">
                        ...
                        <span class="order-status pending-shipment">待发货</span>
                    </div>
                    ...
                    <div class="order-details">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="value">${formatTime(order.paidAt || order.createdAt)}</span>
                        </div>
                    </div>
                    <div class="order-footer">
                        ...
                        <div class="order-actions">
                            ...
                            <button class="btn btn-danger return-btn" data-order-id="${order.id}">
